...
public class MigrationRunner
{
    ...
    public void ApplyEntityDefinitionsToModel(
        ...
        params Type[] filterTypes)
    {
        ...
        ApplyEntityDefinitionsToModel(builder, entityTypes, schemaName, tenantIdPropertyName, tenantIdValue);
    }
    ...
    /// <param name="tenantIdPropertyName"></param>
    /// <param name="tenantIdValue"></param>
    public void ApplyEntityDefinitionsToModel<T>(
        ModelBuilder builder, 
        Assembly assembly,
        string? schemaName = null,
        string? tenantIdPropertyName = null,
    ...
    /// <param name="tenantIdPropertyName"></param>
    /// <param name="tenantIdValue"></param>
    public void ApplyEntityDefinitionsToModel<T1, T2>(
        ModelBuilder builder,
        Assembly assembly,
        string? schemaName = null,
        string? tenantIdPropertyName = null,
        ...
        object? tenantIdValue = null)
    {
        ...
        foreach (var entity in entities)
        {
            ...
            // Shared Schema: Add global query filter for TenantId
            if (!string.IsNullOrWhiteSpace(tenantIdPropertyName) && tenantIdValue != null)
            {
                var parameter = Expression.Parameter(entity.ClrType, "e");
                var property = Expression.Property(parameter, tenantIdPropertyName);
                var constant = Expression.Constant(tenantIdValue);
